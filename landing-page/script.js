...
const translations = {
  sv: {
    ...
    success_dialog_title: "Din forfragan ar skickad",
    success_dialog_body: "Vi har tagit emot dina uppgifter och aterkommer om scootern ar relevant for oss.",
    success_dialog_button: "Stang",
  },
  en: {
